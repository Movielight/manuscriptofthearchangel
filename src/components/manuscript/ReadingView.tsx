...
const sections: { id: Section; title: string; icon: typeof BookOpen; content: React.ReactNode }[] = [
  {
    ...
    icon: Eye,
    content: (
      <div className="space-y-4 text-manuscript-light/90 font-body leading-relaxed">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-manuscript-light/90 font-body leading-relaxed">
        ...
        <div className="bg-manuscript-dark/50 p-6 rounded-xl border border-manuscript-gold/20 my-6">
    ...
    content: (
      <div className="space-y-4 text-manuscript-light/90 font-body leading-relaxed">
        ...
        <div className="grid gap-4 my-6">
          <div className="bg-manuscript-dark/50 p-4 rounded-xl border border-manuscript-gold/20">
            <span className="text-manuscript-gold font-heading text-2xl">7</span>
            <p className="mt-2">The number of divine completion. Seven days of creation, seven archangels, seven seals. It represents God's perfect work.</p>
          </div>
          <div className="bg-manuscript-dark/50 p-4 rounded-xl border border-manuscript-purple/20">
            <span className="text-manuscript-purple font-heading text-2xl">11</span>
            <p className="mt-2">The master number of spiritual awakening. It signifies the gateway between earthly and heavenly realms, the bridge to higher consciousness.</p>
          </div>
          <div className="bg-manuscript-dark/50 p-4 rounded-xl border border-sacred-teal/20">
            <span className="text-sacred-teal font-heading text-2xl">9</span>
            <p className="mt-2">The number of divine service and universal love. It represents completion of a cycle and spiritual enlightenment.</p>
          </div>
        </div>
      ...
      <div className="space-y-4 text-manuscript-light/90 font-body leading-relaxed">
        ...
        <div className="space-y-4 my-6">
          {[
            ...
            <div key={step} className="flex gap-4 bg-manuscript-dark/50 p-4 rounded-xl border border-manuscript-gold/10">
              <div className="bg-manuscript-gold/20 w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0">
                <span className="text-manuscript-gold font-heading">{step}</span>
              </div>
              <div>
                <h4 className="text-manuscript-gold font-heading">{title}</h4>
                <p className="text-sm mt-1">{desc}</p>
              </div>
            </div>
          ))}
        </div>
        <p className="text-manuscript-gold/80 italic text-center">Perform this ritual daily for 7 consecutive days to fully activate its power.</p>
      </div>
    ),
  },
  {
      ...
      <div className="space-y-4 text-manuscript-light/90 font-body leading-relaxed">
        ...
        <div className="space-y-3 my-6">
          {[
            ...
            <div key={sign} className="bg-manuscript-dark/50 p-4 rounded-xl border border-manuscript-gold/10">
              <h4 className="text-manuscript-gold font-heading">{sign}</h4>
              <p className="text-sm mt-1">{desc}</p>
            </div>
          ))}
        </div>
        <p className="text-center">Record every sign you receive in your spiritual journal. The more you acknowledge them, the more they will appear.</p>
      </div>
    ),
  },
  {
    ...
    icon: BookOpen,
    content: (
      <div className="space-y-4 text-manuscript-light/90 font-body leading-relaxed text-center">
        <p className="text-manuscript-gold text-xl font-heading">Congratulations, Seeker.</p>
        ...
        <div className="bg-manuscript-dark/50 p-6 rounded-xl border border-manuscript-gold/20 my-6">
          ...
          <p className="text-manuscript-gold/60 text-sm mt-3">– Saint Ignatius of Loyola</p>
        </div>
        ...
        <p className="text-manuscript-gold mt-8">May the light of the Archangel illuminate your path.</p>
      </div>
    ),
  },
];
    ...
    <div className="min-h-screen pb-24 px-4 pt-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <span className="text-manuscript-light/60 text-sm font-body">
        ...
        >
          {isBookmarked ? (
            ...
            <Bookmark className="w-5 h-5 text-manuscript-light/40" />
          )}
        </button>
      </div>

      {/* Progress Bar */}
      <div className="h-1 bg-manuscript-dark rounded-full mb-6 overflow-hidden">
        <motion.div
          className="h-full bg-manuscript-gold"
          initial={{ width: 0 }}
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          transition={{ duration: 0.3 }}
        >
          <h1 className="font-heading text-2xl text-manuscript-gold mb-6 text-center">
            {currentSection.title}
          </h1>
          <div className={`text-${progress.fontSize === 'small' ? 'sm' : progress.fontSize === 'large' ? 'lg' : 'base'}`}>
      ...
      <div className="flex gap-4 mt-8">
        <button
          ...
          className="flex-1 py-3 rounded-xl border border-manuscript-gold/30 text-manuscript-gold font-body flex items-center justify-center gap-2 disabled:opacity-30 disabled:cursor-not-allowed hover:bg-manuscript-gold/10 transition-colors"
        >
        ...
        <button
          ...
          className="flex-1 py-3 rounded-xl bg-manuscript-gold text-manuscript-dark font-body flex items-center justify-center gap-2 disabled:opacity-30 disabled:cursor-not-allowed hover:bg-manuscript-gold/90 transition-colors"
        >
