    ...
    return (
      ...
      >
        ...
        <div className="pt-6 pb-4">
          ...
          <p className="text-manuscript-light/60">{currentModule.subtitle}</p>
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            exit={{ opacity: 0, x: -20 }}
            className="bg-manuscript-dark/30 rounded-xl border border-manuscript-gold/10 p-5 mb-6"
          >
            {currentSectionIndex === 0 ? (
              ...
              <>
                <h3 className="text-lg font-heading text-manuscript-light mb-4">
              ...
              <>
                <h3 className="text-lg font-heading text-manuscript-light mb-4 flex items-center gap-2">
