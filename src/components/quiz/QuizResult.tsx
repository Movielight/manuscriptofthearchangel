        ...
        delay: 1.7
          ...
          duration: 0.5
            ...
            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
              ...
              The Sacred Manuscript contains the exact prayers, codes, and celestial instructions
              meant specifically for your journey.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto mb-8">
              <div className="bg-muted/50 rounded-xl p-4">
                ...
                <ul className="text-left space-y-2 text-foreground/80">
                  {["Ancient prayers of protection", "Sacred healing codes & frequencies", "Restoration invocations", "Step-by-step spiritual rituals", "Direct angelic communication guides"].map((item, i) => <li key={i} className="flex items-center gap-2">
              ...
              <div className="bg-muted/50 rounded-xl p-4">
                ...
                <ul className="text-left space-y-2 text-foreground/80">
                  {["The full message revealed today", "Personalized prayer sequences", "Protection against negative forces", "Accelerated spiritual healing", "Divine abundance activation"].map((item, i) => <li key={i} className="flex items-center gap-2">
                      <Check className="w-4 h-4 text-primary flex-shrink-0" />
                      <span>{item}</span>
                    </li>)}
                </ul>
          ...
          <div className="max-w-md mx-auto">
            ...
            y: -5
              ...
              <ul className="text-left space-y-3 mb-6">
                {["Complete Sacred Manuscript access", "All prayers, codes & rituals", "Monthly new prayers & revelations", "Exclusive spiritual guidance", "Cancel anytime with grace"].map((item, i) => <li key={i} className="flex items-center gap-2 text-foreground/80">
                    <Check className="w-4 h-4 text-primary flex-shrink-0" />
                    <span>{item}</span>
                  </li>)}
              </ul>
